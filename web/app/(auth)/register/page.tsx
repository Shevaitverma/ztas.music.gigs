...
export default function RegisterPage() {
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      let response = await authApi.verifyGoogle(result.idToken, selectedRole)
      ...
      if (isRequiresRoleResponse(response)) {
        response = await authApi.completeSignup({
          ...
          role: selectedRole,
          name: response.providerProfile.displayName,
        })
      }
      ...
      {step === 'details' && (
        <>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-foreground-muted">Continue with Google to get started</p>
          </div>
