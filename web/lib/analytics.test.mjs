...
import { budgetBand, scrubProps } from './analytics.ts'
...
test('budgetBand never leaks the exact amount', () => {
  assert.equal(budgetBand(4999), '0-5k')
  assert.equal(budgetBand(30000), '25k-50k')
  assert.equal(budgetBand(9_000_000), '2.5L+')
})
